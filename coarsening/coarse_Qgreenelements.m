function [coordinates,newElements,irregular,marked4]...
    =coarse_Qgreenelements(coordinates,elements3,elements4,marked4)

%coarse_Qgreenelements: coarsening of regularity edges to obtain an irregular 
%                   quadrilateral mesh  
%
%Usage:
%
% [coordinates,elements4,irregular,marked4] = 
%           recoarseedges_tri(coordinates,elements3,elements4,marked4)
%
%Comments:
%
%    coarse_Qgreenelements expects as input a mesh described by the 
%    fields coordinates, elements3, elements4, and marked4.
%    It recoarses green refinements to obtain an irregular mesh.
%    Coarsening markings are kept for red elements only, as all green ...
%    patterns are refined anyways.
...
if nnz(find(elements4(:,1)...
    ...
    irregular=[];
    %*** delete marking for green elements
    marked4 = intersect(marked4,1:rdx);
